...
from app.application.dtos.user_dtos import CreateProfessionalRequest, CreateReceptionistRequest, UserResponse
from app.domain.exceptions.user_exceptions import DuplicateEmailException, DuplicateUserException
from app.entrypoints.api.v1.dependencies import get_create_professional_use_case, get_create_receptionist_use_case, get_current_admin
...
@router.post("/professionals", response_model=UserResponse, status_code=status.HTTP_201_CREATED)
